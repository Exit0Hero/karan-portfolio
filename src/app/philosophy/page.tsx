  ...
  return (
    <div className="min-h-screen px-6 py-32">
      <div className="mx-auto max-w-4xl">
        ...
        {/* Scientific OS Recap */}
        <Reveal delay={0.1}>
          <div className="mt-16 rounded-2xl border p-8" style={{ borderColor: "var(--accent)", backgroundColor: "var(--bg-surface)" }}>
            <div className="flex items-center gap-4 mb-6">
              <div className="h-12 w-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: "var(--accent)", color: "var(--bg)" }}>
        ...
        {/* Principles */}
        <StaggerChildren className="mt-16 space-y-6" delay={0.15}>
            ...
            <StaggerItem key={principle.number}>
              ...
              >
                <div className="flex items-start gap-6">
                  <div className="h-12 w-12 shrink-0 rounded-xl flex items-center justify-center text-xl" style={{ backgroundColor: "var(--bg-elevated)", color: "var(--accent)" }}>
                    {principle.icon}
                  </div>
                  <div>
        ...
        {/* Closing Quote */}
        <Reveal delay={0.2}>
          <div className="mt-24 rounded-2xl border p-8 text-center" style={{ borderColor: "var(--accent-secondary)", backgroundColor: "var(--bg-surface)" }}>
